...
namespace Fapturne
{
    internal static class FapturneMenu
    {
        ...
        private static void MyComboPage()
        {
            ...
            MyCombo.AddLabel("Use Duskbringer (Q Spell) on");
            ...
            MyCombo.Add("combo.w",
                new CheckBox("Use Shroud of Darkness (W Spell)"));
            MyCombo.AddLabel("Use Unspeakable Horror (E Spell) on");
            foreach (var enemies in EntityManager.Heroes.Enemies.Where(i => !i.IsMe))
            {
                MyCombo.Add("combo.e" + enemies.ChampionName, new CheckBox("" + enemies.ChampionName));
            }
            MyCombo.AddLabel("Use Paranoia (R Spell) on");
            foreach (var enemies in EntityManager.Heroes.Enemies.Where(i => !i.IsMe))
            {
            ...
            MyCombo.Add("combo.CC", 
                new CheckBox("Use Duskbringer (Q Spell) on CC"));
            MyCombo.Add("combo.CC1",
                new CheckBox("Use Unspeakable Horror (E Spell) on CC"));
            MyCombo.Add("combo.Q1", 
                new Slider("Duskbringer (Q Spell) Overkill", 60, 0, 500));
            MyCombo.Add("combo.R1", 
                new Slider("Paranoia (R Spell) OverKill", 50, 0, 500));
            MyCombo.AddSeparator();
        ...
        private static void MyFarmPage()
        {
            ...
            MyFarm.Add("lc.Q", 
                new CheckBox("Use Duskbringer (Q Spell)"));
            MyFarm.Add("lc.Q2",
                new CheckBox("Use Duskbringer on lasthit (Q Spell)", false));
            MyFarm.Add("lc.Q1",
                new Slider("Min. Minions for Duskbringer", 3, 1, 10));
            MyFarm.AddSeparator();
            MyFarm.AddSeparator();
            MyFarm.Add("lc.E", 
                new CheckBox("Use Unspeakable Horror (E Spell)", false));
            MyFarm.Add("lc.M", 
                new Slider("Min. Mana for Laneclear Spells %", 30));
            MyFarm.AddSeparator();
            MyFarm.AddGroupLabel("Jungle Settings");
            MyFarm.Add("jungle.Q", 
                new CheckBox("Use Duskbringer in Jungle (Q Spell)"));
            MyFarm.Add("jungle.E", 
                new CheckBox("Use Unspeakable Horror in Jungle (E Spell)"));
            MyFarm.AddSeparator();
        ...
        private static void MyHarassPage()
        {
            ...
            MyHarass.AddLabel("Use Duskbringer (Q Spell) on");
            foreach (var enemies in EntityManager.Heroes.Enemies.Where(i => !i.IsMe))
            {
                MyHarass.Add("harass.Q" + enemies.ChampionName, new CheckBox("" + enemies.ChampionName));
            }
            MyHarass.AddLabel("Use Unspeakable Horror (E Spell) on");
            foreach (var enemies in EntityManager.Heroes.Enemies.Where(i => !i.IsMe))
            {
            ...
            MyHarass.Add("killsteal.Q", 
                new CheckBox("Use Duskbringer (Q Spell)", false));
                MyHarass.Add("killsteal.E",
                new CheckBox("Use Unspeakable Horror (E Spell)", false));
            MyHarass.Add("killsteal.R", 
                new CheckBox("Use Paranoia (R Spell)"));
            MyHarass.AddSeparator();
        ...
        private static void MyActivatorPage()
        {
            ...
            MyActivator.Add("hydra.HP",
               new Slider("Use Hydra if hp is lower than {0}(%)", 60, 1));
            MyActivator.Add("tiamat",
                new CheckBox("Use Tiamat"));
            MyActivator.Add("tiamat.HP",
               new Slider("Use Tiamat if hp is lower than {0}(%)", 60, 1));
        ...
        private static void MyOtherFunctionsPage()
        {
            ...
            MyOtherFunctions.Add("interrupt.E",
                new CheckBox("Use Unspeakable Horror (E Spell) For Interrupt"));
            MyOtherFunctions.Add("gapcloser.E",
                new CheckBox("Use Unspeakable Horror (E Spell) For Anti-Gap"));
            MyOtherFunctions.Add("gapcloser.Q",
                new CheckBox("Use Duskbringer (Q Spell) For Anti-Gap"));
            MyOtherFunctions.AddSeparator();
            MyOtherFunctions.AddGroupLabel("Settings for Flee");
            MyOtherFunctions.Add("flee.M", 
                new Slider("Use Duskbringer (Q Spell) for Flee if mana is higher than {0}(%)", 10, 1));
            MyOtherFunctions.AddSeparator();
